...
# stone, the treasure would be hers. Given that the number on the first stone was
# 0, find all the possible values for the number on the last stone.
...
# Output Format 
# Space-separated list of numbers which are the possible values of the last stone
# in increasing order.
...
# Series with different number of final steps for second test
